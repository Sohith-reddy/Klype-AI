  ...
  return (
    <>
      ...
      <Navbar expand="md" className="py-4 px-3">
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="justify-content-center">
            <Nav className="gap-4">
              <Nav.Link href="#" className="text-white fw-semibold">Features</Nav.Link>
              <Nav.Link href="#" className="text-white">How it works</Nav.Link>
              <Nav.Link href="#" className="text-white">Pricing</Nav.Link>
              <Nav.Link href="#" className="text-white">Testimonials</Nav.Link>
      ...
      <Container className="text-center pb-5">
               <div className="badge mt-4 py-2 px-3 rounded-pill text-white" style={{ background: 'linear-gradient(to right, #c800ff, #00f2ff)' }}>
        ...
        <Row className="mt-4">
          <Col md={4} className="mb-4">
            ...
            <p className="text-secondary">hours of strategic content creation and optimization.</p>
          </Col>
          <Col md={4} className="mb-4">
            <h2 className="fw-bold">10,000+</h2>
            <p className="text-secondary">viral posts crafted to maximize reach and engagement.</p>
          </Col>
          <Col md={4} className="mb-4">
            <h2 className="fw-bold">900+</h2>
            <p className="text-secondary">ROI-focused posts designed specifically to drive measurable business results.</p>
          </Col>
        </Row>
      </Container>
    </div>
    ...
    <div className=" back   trusted-section py-5 text-white text-center">
      <Container>
        <h2 className="fw-bold mb-2">
          We’ve Helped Professionals At Top Companies Stay Visible & Get Noticed – Now It’s Your Turn
        </h2>
        <p className="text-secondary mb-5">
          KLYPE converts raw founder experience into content that compounds authority, drives leads, <br />
      ...
      <div className="d-flex justify-content-center flex-wrap gap-4">
        {Array(2).fill(null).map((_, rowIndex) => (
          <div className="d-flex gap-4" key={rowIndex}>
            {companies.map((company, idx) => (
              <div className="d-flex align-items-center gap-2 text-light" key={`${rowIndex}-${idx}`}>
                <i className={`bi ${company === 'Google' ? 'bi-google' : company === 'Amazon' ? 'bi-amazon' : 'bi-bank2'}`} />
                <span>{company}</span>
              </div>
            ))}
          </div>
    ...
    <div className=" back bg-dark text-light py-5 text-center">
      <h2>
        How <span className="text-white">Klype</span> <span className="text-secondary">works?</span>
      </h2>
      ...
      <Container>
        ...
        <Card className="bg-black text-light text-center p-5 rounded-4">
          <Card.Body>
            ...
            <div className="display-4 mt-4">👥👤👥</div> {/* Replace with image if needed */}
          </Card.Body>
        </Card>
      </Container>
    </div>
    <div className="back bg-black text-center text-light py-5">
      <Container>
        {/* Gradient badge */}
        <div className="d-inline-block px-4 py-2 rounded-pill mb-4 fw-semibold" style={{
        ...
        <h3 className="fw-bold text-white mb-3">
          LinkedIn is cracking down on AI<br />generated fluff.
        </h3>

        {/* Supporting text */}
        <p className="text-muted mb-0">
          Our posts read like you, not a bot. Authentic, relatable,<br />
        ...
        <Row className="justify-content-center">
          {pricingData.map((plan, index) => (
            <Col
              ...
              style={{
                backgroundColor: plan.title === 'Premium' ? 'transparent' : '#1a1a1a',
                border: plan.title === 'Premium'
                  ? '1px solid transparent'
                  : '1px solid #333',
                backgroundImage: plan.title === 'Premium'
    ...
    >
      <Container>
        ...
        >
          ...
          <h6 className="text-muted mb-4" style={{ fontWeight: 500 }}>(18 Spots left)</h6>
          ...
          <p className="text-muted">
            Get a 7-day free LinkedIn Content Calendar (worth $297) and experience the power of Klype firsthand!
          </p>
        </div>
      </Container>
    </div>
        ...
        <Row>
          <Col md={4}>
            ...
            <div className="d-flex align-items-center mt-2">
              <FaLinkedin size={20} />
              <span className="ms-2">Skool</span>
            </div>
          </Col>
          <Col md={4}>
